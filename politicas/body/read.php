<section class="py-12 bg-[#F4F4F4]">
    <div class="container">
        <h1 class="font-bold text-center text-4xl text-color-main font-main uppercase">POLÍTICAS</h1>

        <article class="article">
            <h2>Política Privacidade</h2>
            <p>
                A sua privacidade é importante para nós. É política do <?php echo SETTINGS->site_name ?> respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="<?php echo env('APP_URL') ?>"><?php echo SETTINGS->site_name ?></a>, e outros
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o <?php echo SETTINGS->site_name ?> oferece no site e com caráter enunciativo, mas não limitativo:</p>
            <ul>
                <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
                <li>
                    B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, 
                    <a href="https://betnacionalbrasil.br.com">Bet Nacional</a>
                    ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                </li>
                <li>
                    C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do <?php echo SETTINGS->site_name ?>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software
            ...
            <p>Esta política é efetiva a partir de 25 April 2024 11:51</p>
        </article>
    </div>
</section>
