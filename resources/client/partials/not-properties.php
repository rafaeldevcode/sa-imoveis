<section class="p-4 my-10 text-center w-full">
    <p class="text-bold text-2xl">Não foi possível localizar imóveis.</p>

    <p class="text-bold text-2xl">Mas nós estamos prontos para lhe ajudar, e vamos encontrar a melhor solução para você!</p>
